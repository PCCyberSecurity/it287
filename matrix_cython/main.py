...
if settings.USE_NUMBA == True:
    from numba import jit
    from spritelib_numba.fps_counter import FPSCounter
    from spritelib_numba.falling_line import FallingLine, TailCharacter
elif settings.USE_CYTHON == True:
    from spritelib_cy.fps_counter import FPSCounter
    from spritelib_cy.falling_line import FallingLine, TailCharacter
else:
    from spritelib_cy.fps_counter import FPSCounter
    from spritelib_cy.falling_line import FallingLine, TailCharacter
...
def main():
    ...
    flags = DOUBLEBUF # | FULLSCREEN | HWSURFACE # DOUBLEBUF | FULLSCREEN | SWSURFACE | HWSURFACE
    depth = 24
    show_fps = True
    PROFILE_APP = True
    ...
    FallingLine.generate_lines(max_lines, matrix_font)    
    ...
    fps = FPSCounter(10, 10, screen=screen, anim_clock=clock)
    # chr(0x42a)
    ...
    while running == True:
        ...
        FallingLine.update_lines(time_elapsed_seconds, clock)
